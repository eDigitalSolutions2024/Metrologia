...
router.put("/menu", requireRole("admin"), auditar("permisos_menu_actualizados", "Configuracion"), c.actualizarMenuPermisos);
...
router.put("/colores", requireRole("admin"), c.actualizarColores);
